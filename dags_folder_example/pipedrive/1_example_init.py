...
@dlt.source
def pipedrive_source(api_secret_key=dlt.secrets.value):
    return pipedrive_resource(api_secret_key)
...
def pipedrive_resource(api_secret_key=dlt.secrets.value):
